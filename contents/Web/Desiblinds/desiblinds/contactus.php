<?php include "header.php"; ?>
  <div id="content-top">
    ...
    <div id="products-1">
    <h1>Call us or contact us here</h1>
    <br />
    <p class="style2">    
    ...
    <form id="emf-form" enctype="multipart/form-data" method="post" action="http://www.emailmeform.com/builder/form/0T1SjJr7oU3v1eyb3" name="emf-form">
  <div id="form-left">
        
        <font face="Verdana" size="2" color="#000000"><b>Subject</b></font> <span style="color:red;"><small>*</small></span><br />
        ...
        <font face="Verdana" size="2" color="#000000"><b>Name</b></font> <span style="color:red;"><small>*</small></span><br />
        <input id="element_1" name="element_1" value="" size="50" class="validate[required]" type="text" />
        <div style="padding-bottom:8px;color:#000000;"></div>
        
        <font face="Verdana" size="2" color="#000000"><b>Email</b></font> <span style="color:red;"><small>*</small></span><br />
        ...
        <div id="form-right">
        <font face="Verdana" size="2" color="#000000"><b>Message</b></font> <span style="color:red;"><small>*</small></span><br />
        <textarea id="element_2" name="element_2" cols="42" rows="8" class="validate[required]"></textarea>
        <div style="padding-bottom:8px;color:#000000;"></div>
        
        <h1 style="float:right;">Or Give Us A Call At:</h1> <h1 style="float:right;">760 956-1249</h1>
        
        </div>
        <div id="address-2">
        16666 Smoketree St A-4, Hesperia, CA 92345
        </div>
