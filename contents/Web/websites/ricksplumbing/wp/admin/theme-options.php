...
$options[] = array( "name" => "Contact Phone",
					"desc" => "Enter your prefered contact number into the field",
					"id" => $shortname."_phone",
					"std" => "951-123-4567",
					"type" => "text");   
...
$options[] = array( "name" => "Contact Email",
					"desc" => "Enter your contact email into the field",
					"id" => $shortname."_email",
					"std" => "your_email@here.com",
					"type" => "text");   
...
$options[] = array( "name" => "Home Greeting",
					"type" => "heading"); 

//Select Category
$options[] = array( "name" => "Select a Category options select",
...
//Category's
$options[] = array( "name" => "Category's",
					"type" => "heading"); 

//Select Category Slider
$options[] = array( "name" => "Select a Category For Slider Images",
					"desc" => "Hit the dropdown and select a category from the listings",
...
//Select Category Slider Thumbnails
$options[] = array( "name" => "Select a Category For Slider Thumbnails",
					"desc" => "Hit the dropdown and select a category from the listings",
...
//Select Category Gallery
$options[] = array( "name" => "Select a Category For Gallery",
					"desc" => "Hit the dropdown and select a category from the listings",
...
//Select Category Gallery
$options[] = array( "name" => "Select a Category For Bottom Services",
					"desc" => "Hit the dropdown and select a category from the listings",
					"id" => $shortname."_bottom",
					"std" => "Select a category:",
					"type" => "select",
					"options" => $of_categories);

//Select Category Gallery
$options[] = array( "name" => "Select a Category For Bottom Areas",
					"desc" => "Hit the dropdown and select a category from the listings",
					"id" => $shortname."_areas",
					"std" => "Select a category:",
					"type" => "select",
