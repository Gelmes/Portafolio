...
<div id="copyright">Copyright 2012, <? bloginfo('name'); ?>. <?php echo get_option('of_copyright') ?> | Site created by <a href="http://www.pdrmediaonline.com/">PDR Media</a></div>
...
<a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"><img src="<? bloginfo('stylesheet_directory'); ?>/images/Close_Icon.png" width="30px" height="30px" style="
  position:absolute;
  top:5px;
  right:5px;"/></a>
