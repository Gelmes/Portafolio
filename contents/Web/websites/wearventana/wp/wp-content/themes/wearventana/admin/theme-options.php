...
//Select Category
$options[] = array( "name" => "Select a Category option to display your welcome area of home page",
...
//Select Category
$options[] = array( "name" => "Select a Category option to display your banners on the home page",
					"desc" => "Hit the dropdown and select a category from the listings",
...
//Options Heading
$options[] = array( "name" => "Teams Page Options",
					"type" => "heading");
					
//Select Category
$options[] = array( "name" => "Select a Category to display your package 1 options",
					"desc" => "Hit the dropdown and select a category from the listings",
					"id" => $shortname."_package1",
					"std" => "Select a category:",
					"type" => "select",
					"options" => $of_categories);
//Select Category
$options[] = array( "name" => "Select a Category to display your package 2 options",
					"desc" => "Hit the dropdown and select a category from the listings",
					"id" => $shortname."_package2",
					"std" => "Select a category:",
					"type" => "select",
					"options" => $of_categories);
					
//Select Category
$options[] = array( "name" => "Select a Category to display your package 3 options",
					"desc" => "Hit the dropdown and select a category from the listings",
					"id" => $shortname."_package3",
					"std" => "Select a category:",
					"type" => "select",
					"options" => $of_categories);
					
//Options Heading
$options[] = array( "name" => "Steps Options",
					"type" => "heading");
					
//Text Area
$options[] = array( "name" => "Enter your Steps",
...
//Options Heading
$options[] = array( "name" => "About Page Options",
					"type" => "heading");
					
//Select Category
$options[] = array( "name" => "Select a Category to display your About Us content",
					"desc" => "Hit the dropdown and select a category from the listings",
					"id" => $shortname."_about",
					"std" => "Select a category:",
					"type" => "select",
