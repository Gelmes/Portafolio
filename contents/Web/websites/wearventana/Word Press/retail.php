...
<script type="text/javascript" src="<? bloginfo('stylesheet_directory'); ?>/js/jquery.aw-showcase.min.js"></script>
...
<div id="content-teams">
  <div id="top">
  <div id="content-title"><img src="<? bloginfo('stylesheet_directory'); ?>/images/title-2.png" /></div>
  <div id="retail">
  ...
  <div id="showcase" class="showcase">
		...
		<div class="showcase-slide">
			<div class="showcase-content">
				<img src="<? bloginfo('stylesheet_directory'); ?>/images/bikeride.png"  />
			</div>
