...
<link href="<? bloginfo('stylesheet_directory'); ?>/css/nice-menu.css" rel="stylesheet" type="text/css" />
...
<link href="<? bloginfo('stylesheet_directory'); ?>/css/coin-slider-styles.css" rel="stylesheet" type="text/css" />
...
<div id="wrapper">
	...
	<div id="header">
    	<div id="logo"><a href="index.php"><img src="<? bloginfo('stylesheet_directory'); ?>/images/logo.png" /></a></div>
      <div id="menu">
      <a href="#">HOME</a> | <a href="#">OFFICE SUITES</a> | <a href="#">BUSINESS AMENITIES</a> | <a href="#">OFFICES FOR LEASE</a> | <a href="#">CONTACT US</a>
    </div>
