...
$sc_gateway_username = "25793";
$secure_order_script_url = "https://secure.paymentclearing.com/cgi-bin/rc/ord.cgi";
$mername = "CommerceSQL Shopping Cart";
$acceptcards = "1";
$acceptchecks = "0";
$accepteft = "0";
$altaddr = "1";
...
{
   $form_data{'comments'} = "No Comments";
}
if (! $form_data{'mailinglist'})
{
   $form_data{'mailinglist'} = "no";
}

@months = ('January','February','March','April','May','June','July','August','September','October','November','December');
$cc_month_name = $months[($form_data{'Payment_Card_Exp_Month'}-1)];

print qq~
</FORM>
<FORM METHOD=POST ACTION=\"$secure_order_script_url\">

<INPUT type=\"HIDDEN\" NAME="first_name" VALUE=\"$form_data{'BillTo_First_Name'}\">
<INPUT type=\"HIDDEN\" NAME="last_name" VALUE=\"$form_data{'BillTo_Last_Name'}\">
...
<INPUT type=\"HIDDEN\" NAME="ccnum" VALUE=\"$form_data{'Payment_Card_Number'}\">

<INPUT type=\"HIDDEN\" NAME="ccmo" VALUE=\"$cc_month_name\">
<INPUT type=\"HIDDEN\" NAME="ccyr" VALUE=\"$form_data{'Payment_Card_Exp_Year'}\">

<INPUT type=\"HIDDEN\" NAME="sfname" VALUE=\"$form_data{'ShipTo_First_Name'}\">
<INPUT type=\"HIDDEN\" NAME="slname" VALUE=\"$form_data{'ShipTo_Last_Name'}\">
<INPUT type=\"HIDDEN\" NAME="saddr" VALUE=\"$form_data{'ShipTo_Street_Line1'}\">
...
<INPUT type=\"HIDDEN\" NAME="sctry" VALUE=\"$form_data{'ShipTo_Country'}\">

<INPUT TYPE=\"HIDDEN\" NAME=\"1-cost\" VALUE=\"$authPrice\">

<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p1\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p1\" VALUE=\"$final_shipping\">
<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p2\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p2\" VALUE=\"$final_discount\">
<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p3\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p3\" VALUE=\"$final_sales_tax\">
...
<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p8\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p8\" VALUE=\"$COMMENTS\">
<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p9\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p9\" VALUE=\"$form_data{'mailinglist'}\">
<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p10\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p10\" VALUE=\"$upgradeShipValue[$form_data{'upgradeShipping'}]\">
<INPUT type=\"HIDDEN\" name=\"passback\" value=\"p11\">
<INPUT TYPE=\"HIDDEN\" NAME=\"p11\" VALUE=\"$form_data{'Ecom_BillTo_Telecom_Fax_Number'}\">

<INPUT TYPE=\"HIDDEN\" NAME=\"home_page\" VALUE=\"$sc_order_script_url\">

<INPUT TYPE=\"HIDDEN\" NAME=\"ret_addr\" VALUE=\"$sc_order_script_url\">
<!--- INPUT TYPE=\"HIDDEN\" NAME=\"ret_addr\" VALUE=\"http://commercesql.com/test/admin/tester.cgi\" --->
...
local($subtotal, $total_quantity,
   ...
   if (! $form_data{'err'} && ! $form_data{'die'})
   {
      ####################################################################
      # Do all the work...
      ####################################################################
      ...
      my($query) = "SELECT * FROM $sc_mysql_cart_table where cart_id = \'$form_data{'p4'}\'";
      ...
      $text_of_confirm_email .= "\n";
      $text_of_confirm_email .= "INVOICE:       $form_data{'p5'}\n";
      $text_of_confirm_email .= "SHIPPING:      $form_data{'p1'}\n";
      $text_of_confirm_email .= "DISCOUNT:      $form_data{'p2'}\n";
      $text_of_confirm_email .= "SALES TAX:     $form_data{'p3'}\n";
      $text_of_confirm_email .= "TOTAL:         $form_data{'total'}\n";
      ...
      my($query) = "SELECT * FROM $sc_mysql_cart_table where cart_id = \'$form_data{'p4'}\'";
   	...
   	while(@row = $sth->fetchrow)  {
   	    ...
   	    $COMMENTS = $form_data{'p8'};
   	    $COMMENTS =~ tr/:$\@\"\n\%\&//d;
   	    $COMMENTS =~ s/\'/\\\'/g;

   	    $DISCOUNT = $form_data{'p2'};
   	    $DISCOUNT =~ tr/:$\@\"\%\&//d;
          $DISCOUNT =~ tr/$sc_money_symbol//;

          $SHIPPING = $form_data{'p1'};
          $SHIPPING =~ tr/:$\@\"\%\&//d;
          $SHIPPING =~ tr/$sc_money_symbol//;

          $SALESTAX = $form_data{'p3'};
          $SALESTAX =~ tr/:$\@\"\%\&//d;
          $SALESTAX =~ tr/$sc_money_symbol//;

          $GRANDTOTAL = $form_data{'total'};
          $GRANDTOTAL =~ tr/:$\@\"\%\&//d;
          ...
          $query = "insert into $sc_mysql_ord_table values (\'\',\'$form_data{'p5'}\',\'$form_data{'first_name'} $form_data{'last_name'}\',\'$form_data{'address'}\',\'$form_data{'city'}\',\'$form_data{'state'}\',\'$form_data{'zip'}\',\'$form_data{'country'}\',\'$form_data{'sfname'} $form_data{'slname'}\',\'$form_data{'saddr'}\',\'$form_data{'scity'}\',\'$form_data{'sstate'}\',\'$form_data{'szip'}\',\'$form_data{'sctry'}\',\'$form_data{'phone'}\',\'$form_data{'p11'}\',\'$form_data{'email'}\',\'$form_data{'method'}\',\'$form_data{'ccname'}\',\'$form_data{'card_num'}\',\'$form_data{'exp_date'}\',\'$form_data{'p10'}\',\'$COMMENTS\',\'$cart_fields[0]\',\'$DISCOUNT\',\'$cart_fields[2]\',\'$PRICE\',\'$cart_fields[4]\',\'$cart_fields[7]\',\'$PRAFO\',\'$LINE\',\'$EXTAMT\',\'$SUBTOTAL\',\'$SHIPPING\',\'$SALESTAX\',\'$GRANDTOTAL\',\'\',\'$ENV{'REMOTE_ADDR'}\',\'$time\')";
          $dbh->do($query);
      }
      $sth->finish;

      if ($form_data{'p9'} =~ /CHECKED/i)
      {
      ...
      {
         &send_mail($sc_order_email, $sc_order_email, "Online Order",$form_data{'total'});
      }
      ...
      $query = "DELETE from $sc_mysql_cart_table where cart_id =\'$form_data{'p4'}\'";
      $dbh->do($query);
      $dbh->disconnect;
      ...
      ~;
         ...
         &SecureStoreHeader;
   	   ...
   	   $message = "<center>There was a problem with your order<BR><BR>";
   	   $message .= "$form_data{'err'}";
   	   $message .= "<br><br><p><a href=\"javascript:history.go(-2)\">Back to Order Form</a></p></center>";
