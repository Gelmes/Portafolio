...
$admin_email        = 'info@themansmeds.com';
...
#$html_prd_pages     = 'http://www.pdrmediaonline.com/HTML-CART';
$html_prd_pages     = '.';
...
$secure_order_url = 'admin/orders.cgi';
...
$domain_name_for_cookie = '.pdrmediaonline.com';
