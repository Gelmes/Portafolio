...
<div id="wrapper">
    ...
    <div id="logo">Dream Vacations OC</div>
    <div id="phone">(714) 495-8787</div>
    <div id="tag_line">RESERVE YOUR DISNEYLAND PARK HOPPER TICKETS</div>
    <div id="call">Call Now!</div>     
