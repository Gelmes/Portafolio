...
<div id="window" class="shadow">
    ...
    <a href="index.php"><div id="logo" class="text_shadow"><img src="images/sb_logo.png" alt="SkateBuddy logo" width="60px" />  SkateBuddy</div></a>

    <div id="search_box" class="field_div">
